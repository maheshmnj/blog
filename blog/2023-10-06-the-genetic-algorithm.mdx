...
You can find the complete source code for this problem [here](https://github.com/maheshmnj/POPULAR_CODING_Questions_Solution/blob/master/algorithms/advanced/genetic.py).
